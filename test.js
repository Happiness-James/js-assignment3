class Mkulima{
    ...
    farm1.addFarm("001","Luwi","Mutuma","01127387", "B2b");
    farm1.addFarm("002","Nancy","Nganga","01187446", "B3b");
    farm1.addFarm("003","Ashly","Ochwada","011484586", "B4b");
    console.log(farm1.farms);
    
    farm1.removeFarm("002");
    console.log()